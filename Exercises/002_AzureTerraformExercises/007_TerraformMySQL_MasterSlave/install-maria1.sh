...
#
configure_slave() {
# echo "change master to master_host='$MASTERIP', master_user='"$DB_REP_USR"', master_password='"$DB_REP_PWD"', master_log_file='$MASTERLOG', master_log_pos=$MASTERPOS;" | m1sql
echo "change master to master_host='$MASTERIP', master_user='"$DB_REP_USR"', master_password='"$DB_REP_PWD"', master_log_file='$MASTERLOG', master_log_pos=$MASTERPOS;"
}
